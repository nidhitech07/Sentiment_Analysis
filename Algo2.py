...
class Welcome_To_Sentiment_Analysis:
    def __init__(self, top=None):
        ...
        top.title("Welcome To Sentiment Analysis using NaiveBayes")
        ...
        self.Frame2.configure(relief=GROOVE)
        self.Frame2.configure(background="#f4f4ff")
        ...
        self.Label1.configure(text='''Welcome to Sentiment Analysis using NaiveBayes''')
